...
public class Building_Crucible  : Building_Enterable, IStoreSettingsParent, IThingHolderWithDrawnPawn
{
	...
	private Building_AncestorCore ancestorCore => (Building_AncestorCore)affectedByFacilities.LinkedFacilitiesListForReading.FirstOrFallback(facility => facility.def == Votann40kDefOf.BEWH_AncestorCore);
